...
import 'caregiver_reset_password_page.dart';

class CaregiverVerifyCodePage extends StatefulWidget {
  final String email;
  const CaregiverVerifyCodePage({super.key, required this.email});

  @override
  State<CaregiverVerifyCodePage> createState() => _CaregiverVerifyCodePageState();
}

class _CaregiverVerifyCodePageState extends State<CaregiverVerifyCodePage>
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('${ApiConfig.baseUrl}/auth/caregiver/verify-reset-code'),
      ...
      body: Stack(children: [
        Positioned(top: -60, right: -60,
          child: Container(width: 200, height: 200,
            decoration: BoxDecoration(shape: BoxShape.circle, color: primaryLt.withOpacity(0.1)))),
